...
from scripts.util.gaussian_process_util import read_poly_config_data_from_csv
import matplotlib.pyplot as plt
cfg1=PolynomialControllerConfig()
cfg2=PolynomialControllerConfig()
trial_name = "dynamic_params"
read_poly_config_data_from_csv(cfg=cfg1, filename="../params_csv/dyn_par_9705.csv", trial_name=trial_name)
read_poly_config_data_from_csv(cfg=cfg2, filename="../params_csv/dyn_par_9858.csv", trial_name=trial_name)
cfg1.plot_lambdas()
plt.title("lambdas_9705")
cfg2.plot_lambdas()
plt.show()