...
def run_episode(Tc=2e-3, duration=1500.0, cfg=ControllerConfig()):
    ...
    print(f"RUNNING EPISODE WITH DURATION: {duration}" )
...
cfg.gamma = 19.935364412970603
cfg.lambda_acc = 3.9218194931767625e-08
cfg.lambda_pos = 96486.8015706575
cfg.lambda_scaling =16.072035286121217
